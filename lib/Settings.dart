        ...
        children: [
          ...
          Padding(
            ...
            child: ElevatedButton.icon(onPressed: () async{
              tryUpdate(context);
            }, icon: const Icon(Icons.update), label: const Text("Güncelleme Denetle")),
          ),
        ],
      )
    );
            ...
            return AlertDialog(
              ...
              actions: <Widget>[
                Row(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: status != "Güncellemek ister misiniz?"?null: (){
                    ...
                    ElevatedButton(
                      onPressed: status != "Güncellemek ister misiniz?"?null: () async{
